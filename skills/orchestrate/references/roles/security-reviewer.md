...
Reviews the implementation for security vulnerabilities. Checks for OWASP Top 10 issues and common security mistakes in the changed code. Reports findings by severity. Codebase in, security report out.
