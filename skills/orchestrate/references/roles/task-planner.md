...
Decomposes a requirements doc, architecture plan, and test plan into an ordered sequence of implementation phases. Each phase is a cohesive unit of work for a single engineer. Produces individual phase files and a phase index for the orchestrator. Docs folder in, phase files out.
