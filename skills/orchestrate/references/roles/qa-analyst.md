...
Produces a user-focused test plan from a requirements document. Maps each user story and acceptance criterion to test cases that describe what real users will do, including risky inputs and edge cases a user might actually trigger. Requirements doc in, test plan out.
...
Write your output to `{docs_folder}/test-plan.md` using the available file-editing tools, in this structure:
